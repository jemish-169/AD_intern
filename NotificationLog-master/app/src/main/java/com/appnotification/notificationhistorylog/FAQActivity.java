...
//    InterstitialAd mInterstitialAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linernotification = (LinearLayout)findViewById(R.id.linerfaq);
        linernotification.setVisibility(View.GONE);



        progressBar = (ProgressBar)findViewById(R.id.progressBarfaq);
...
//    }
    ...
    private void mail() {
        ...
        android.app.AlertDialog dialog = new android.app.AlertDialog.Builder(FAQActivity.this,R.style.AlertDialogedit)
                .setTitle("Your Query")
